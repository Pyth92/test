...
consumerKey <- 'La7CjZbHXvpRxefVAmawCd2GT' #put the Consumer Key from Twitter Application
consumerSecret <- 'R54JqpjD3rt9ogN0Vpm8Lo7Jz9X29YL5LrIteaV2hQlCj2gnwE'  #put the Consumer Secret from Twitter Application
